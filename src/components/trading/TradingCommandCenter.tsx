...
export function TradingCommandCenter({
  ...
  return (
    <div className="relative glass-panel border-b border-border/50 p-4 shadow-elevated">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 flex-1">
          <div className="relative flex-1 max-w-md group">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-input/50 border border-border/50 rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary focus:shadow-[0_0_20px_hsl(var(--primary)/0.3)] transition-all backdrop-blur-sm"
            />
          </div>
        </div>
        ...
        {currentPrice && (
          <div className="flex items-center gap-3 px-6 py-2 glass rounded-lg border border-primary/20">
            <div className="text-center">
              <div className="text-xs text-muted-foreground mb-1 uppercase tracking-wider">Current Price</div>
