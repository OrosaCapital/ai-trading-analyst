    ...
    extend: {
      colors: {
        ...
        sentiment: {
          ...
          "high-greed": "hsl(var(--sentiment-high-greed))",
          greed: "hsl(var(--sentiment-greed))",
          "mild-greed": "hsl(var(--sentiment-mild-greed))",
          neutral: "hsl(var(--sentiment-neutral))",
          "mild-caution": "hsl(var(--sentiment-mild-caution))",
          caution: "hsl(var(--sentiment-caution))",
          concern: "hsl(var(--sentiment-concern))",
          fear: "hsl(var(--sentiment-fear))",
          "max-fear": "hsl(var(--sentiment-max-fear))",
        },
        chart: {
